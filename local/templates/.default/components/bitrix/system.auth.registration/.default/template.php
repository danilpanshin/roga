...
<form method="post" action="<?=$arResult["AUTH_URL"]?>" name="bform" enctype="multipart/form-data">
	...
	<input type="hidden" name="backurl" value="/auth/registration.php" />
...
<?endif?>
		...
		<tr>
		<td colspan="2"><?echo $arResult["GROUP_POLICY"]["PASSWORD_REQUIREMENTS"];?></td>
		</tr>
		<tr>
			<td><?if($arResult["EMAIL_REQUIRED"]):?><span class="starrequired">*</span><?endif?><?=GetMessage("AUTH_EMAIL")?></td>
			<td><input type="text" name="USER_EMAIL" maxlength="255" value="<?=$arResult["USER_EMAIL"]?>" class="bx-auth-input" placeholder="<?=GetMessage('EMAIL_PLACEHOLDER')?>" /></td>
		</tr>
<?// ********************* User properties ***************************************************?>
